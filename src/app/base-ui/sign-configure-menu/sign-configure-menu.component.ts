...
@Component({
    ...
    imports: [SignSizeComponent, SignTypeComponent, IdentificationComponent, InputNumber, FormsModule, SignArrowComponent, Divider, SignArrowGroupComponent, SignPartComponent]
})
